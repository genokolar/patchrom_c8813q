...
.field private static mIsBootOptimiz:Z
...
.method static constructor <clinit>()V
    ...
    const-string v0, "ro.config.hw_boot_optimiz"
    ...
    sput-boolean v0, Lcom/android/internal/os/ZygoteInit;->mIsBootOptimiz:Z
...
.method private static preloadClasses()V
    ...
    .prologue
    sget-boolean v13, Lcom/android/internal/os/ZygoteInit;->mIsBootOptimiz:Z

    if-eqz v13, :cond_0

    new-instance v6, Lcom/android/internal/os/PrealoadClassThread;

    const-string v13, "preloaded-classes0"

    invoke-direct {v6, v13}, Lcom/android/internal/os/PrealoadClassThread;-><init>(Ljava/lang/String;)V

    .local v6, preloadClassThread0:Lcom/android/internal/os/PrealoadClassThread;
    new-instance v7, Lcom/android/internal/os/PrealoadClassThread;

    const-string v13, "preloaded-classes1"

    invoke-direct {v7, v13}, Lcom/android/internal/os/PrealoadClassThread;-><init>(Ljava/lang/String;)V

    .local v7, preloadClassThread1:Ljava/lang/Thread;
    new-instance v8, Lcom/android/internal/os/PrealoadClassThread;

    const-string v13, "preloaded-classes2"

    invoke-direct {v8, v13}, Lcom/android/internal/os/PrealoadClassThread;-><init>(Ljava/lang/String;)V

    .local v8, preloadClassThread2:Ljava/lang/Thread;
    const/16 v13, 0xa

    invoke-virtual {v7, v13}, Ljava/lang/Thread;->setPriority(I)V

    invoke-virtual {v6}, Lcom/android/internal/os/PrealoadClassThread;->preloadClassesInThread()V

    invoke-virtual {v7}, Ljava/lang/Thread;->start()V

    invoke-virtual {v8}, Ljava/lang/Thread;->start()V

    .end local v6           #preloadClassThread0:Lcom/android/internal/os/PrealoadClassThread;
    .end local v7           #preloadClassThread1:Ljava/lang/Thread;
    .end local v8           #preloadClassThread2:Ljava/lang/Thread;
    ...
    invoke-virtual {v9}, Ldalvik/system/VMRuntime;->getTargetHeapUtilization()F
    ...
    invoke-virtual {v9, v13}, Ldalvik/system/VMRuntime;->setTargetHeapUtilization(F)F
    ...
    invoke-virtual {v9, v2}, Ldalvik/system/VMRuntime;->setTargetHeapUtilization(F)F
    ...
    instance-of v13, v12, Ljava/lang/Error;
    ...
    :cond_4
    :try_start_5
    instance-of v13, v12, Ljava/lang/RuntimeException;
...
.method private static preloadResources()V
    ...
    sget-boolean v8, Lcom/android/internal/os/ZygoteInit;->mIsBootOptimiz:Z
