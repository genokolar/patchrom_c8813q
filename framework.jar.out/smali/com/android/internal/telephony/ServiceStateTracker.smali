...
.field static final HWNFF_RSSI_SIM1:Ljava/lang/String; = "gsm.rssi.sim1"

.field static final HWNFF_RSSI_SIM2:Ljava/lang/String; = "gsm.rssi.sim2"
...
.field protected static final SPECIAL_PLMN_STRING:Ljava/lang/String; = "45502-455002-460000-460001-460002-460003-"
...
.method protected isPlmnInDefaultsXml(Ljava/lang/String;)Z
    .locals 4
    .parameter "plmn"
    ...
    const-string v1, "45502-455002-460000-460001-460002-460003-"
...
.method protected onSignalStrengthResult(Landroid/os/AsyncResult;Lcom/android/internal/telephony/PhoneBase;Z)V
    ...
    invoke-virtual {v4, p3}, Landroid/telephony/SignalStrength;->setGsm(Z)V
    ...
    :try_start_0
    invoke-virtual {p2}, Lcom/android/internal/telephony/PhoneBase;->getSubscription()I
    ...
    .local v2, simCardState:I
    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "hwnff: [SUB"
    ...
    const-string v5, "hwnff: write to prop SignalStrength.getDbm()="
    ...
    invoke-direct {v4, p3}, Landroid/telephony/SignalStrength;-><init>(Z)V

    iput-object v4, p0, Lcom/android/internal/telephony/ServiceStateTracker;->mSignalStrength:Landroid/telephony/SignalStrength;

    goto/16 :goto_0

    .restart local v2       #simCardState:I
...
.method public powerOffRadioSafely(Lcom/android/internal/telephony/DataConnectionTracker;)V
    ...
    const-string v1, "Turn off the radio right away"
...
.method protected setCustLongOperator(Ljava/lang/String;Ljava/lang/String;)V
    .locals 8
    .parameter "netWorkMccMnc"
    .parameter "cntelcustplmn"
    ...
    :cond_0
    const-string v4, "[operator] no need to set the long name"
    ...
    .local v2, custStr2:Ljava/lang/String;
    const-string v4, ":"
    ...
    const-string v5, "[operator] OperatorAlphaLong = "
    ...
    .end local v2           #custStr2:Ljava/lang/String;
    .end local v3           #semicolonIdx:I
    :cond_4
    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "[operator] the operator:"
    ...
    const-string v5, " has no custom-made!"
