...
.field private static final isHwClipOverrideEnabled:Z
...
.method static constructor <clinit>()V
    ...
    const-string v0, "ro.config.hw_clip_override"

    invoke-static {v0, v2}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lcom/android/internal/telephony/RIL;->isHwClipOverrideEnabled:Z
...
.method private responseCallList(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    sget-boolean v8, Lcom/android/internal/telephony/RIL;->isHwClipOverrideEnabled:Z

    if-eqz v8, :cond_0

    sget v8, Lcom/android/internal/telephony/Connection;->PRESENTATION_ALLOWED:I

    iget v11, v0, Lcom/android/internal/telephony/DriverCall;->numberPresentation:I
    ...
    const-string v11, "CLIP override feature set, change Presentation Indicator from "
    ...
    const-string v11, " to PRESENTATION_ALLOWED"
