...
.field public static final INTENT_KEY_SUBSCRIPTION_MODE:Ljava/lang/String; = "sub_mode"
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mReadyRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mPersoLockedRegistrants:Landroid/os/RegistrantList;
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mCdmaSubscriptionFromNv:Z
    ...
    iput-boolean v2, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mIsMultimodeCdmaPhone:Z

    iput-boolean v0, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mQuietMode:Z

    iput-boolean v0, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mInitialized:Z

    sget-object v2, Lcom/android/internal/telephony/IccCard$State;->UNKNOWN:Lcom/android/internal/telephony/IccCard$State;

    iput-object v2, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mExternalState:Lcom/android/internal/telephony/IccCard$State;
    ...
    :cond_0
    iput-boolean v0, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->IS_CHINA_TELECOM:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v1, "ro.config.ct_roaming_card"
    ...
    invoke-virtual {v1, v3}, Lcom/huawei/telephony/HuaweiTelephonyManager;->getCardType(I)I
    ...
    const-string v1, "android.intent.action.RESTORE_INITIAL_STATE"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v0, intent:Landroid/content/Intent;
    const-string v1, "sub_mode"

    invoke-virtual {v0, v1, v3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v1, "Broadcasting intent ACTION_CHANGE_SUBSCRIPTION_MODE sub_mode=0"
    ...
    invoke-virtual {p0, v1, v4}, Lcom/android/internal/telephony/uicc/IccCardProxy;->broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected registerUiccCardEvents()V
    ...
    invoke-virtual {v0, p0, v1, v2}, Lcom/android/internal/telephony/uicc/IccRecords;->registerForIccRefresh(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method protected unregisterUiccCardEvents()V
    ...
    invoke-virtual {v0, p0}, Lcom/android/internal/telephony/uicc/IccRecords;->unRegisterForIccRefresh(Landroid/os/Handler;)V
...
.method protected updateExternalState()V
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/uicc/UiccCard;->hasAppActived()Z
