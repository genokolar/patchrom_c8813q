.class Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;
...
# direct methods
.method public constructor <init>(Lcom/android/internal/telephony/uicc/SIMRecords;Lcom/android/internal/telephony/uicc/SIMRecords;)V
    .locals 0
    .parameter
    .parameter "simRecords"

    .prologue
    iput-object p1, p0, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->this$0:Lcom/android/internal/telephony/uicc/SIMRecords;

    invoke-direct/range {p0 .. p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->mSimRecords:Lcom/android/internal/telephony/uicc/SIMRecords;
...
.method private checkGlobalAutoMatchParam()V
    ...
    .prologue
    iget-object v2, p0, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->this$0:Lcom/android/internal/telephony/uicc/SIMRecords;
...
.method private checkGlobalEccNum()V
    .locals 4

    .prologue
    iget-object v2, p0, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->mSimRecords:Lcom/android/internal/telephony/uicc/SIMRecords;

    invoke-virtual {v2}, Lcom/android/internal/telephony/uicc/SIMRecords;->getOperatorNumeric()Ljava/lang/String;

    move-result-object v0

    .local v0, currentMccmnc:Ljava/lang/String;
    if-nez v0, :cond_0
    ...
    const-string v3, "broadcast TelephonyIntents.ACTION_CHECK_GLOBAL_ECC_NUM_PARAM"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v1, Landroid/content/Intent;

    const-string v2, "android.intent.action.ACTION_CHECK_GLOBAL_ECC_NUM_PARAM"
...
.method public checkAgpsServers()V
    ...
    .prologue
    iget-object v7, p0, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->this$0:Lcom/android/internal/telephony/uicc/SIMRecords;
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->getAgpsServerRow(Lorg/xmlpull/v1/XmlPullParser;)Landroid/content/ContentValues;
    ...
    :cond_3
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->broadcastAgpsServerConf(Landroid/content/ContentValues;)V
    :try_end_1
...
.method public checkPrePostPayMactchParam()V
    ...
    .prologue
    iget-object v3, p0, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->mSimRecords:Lcom/android/internal/telephony/uicc/SIMRecords;
...
.method public loadGID1()V
    ...
    .prologue
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->this$0:Lcom/android/internal/telephony/uicc/SIMRecords;
    ...
    #getter for: Lcom/android/internal/telephony/uicc/SIMRecords;->handlerEx:Landroid/os/Handler;
    invoke-static {v2}, Lcom/android/internal/telephony/uicc/SIMRecords;->access$000(Lcom/android/internal/telephony/uicc/SIMRecords;)Landroid/os/Handler;
    ...
    iget v1, v0, Lcom/android/internal/telephony/uicc/IccRecords;->recordsToLoad:I

    add-int/lit8 v1, v1, 0x1

    iput v1, v0, Lcom/android/internal/telephony/uicc/IccRecords;->recordsToLoad:I
...
.method public onAllRecordsLoaded()V
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->mSimRecords:Lcom/android/internal/telephony/uicc/SIMRecords;

    invoke-static {v0, v1}, Lcom/android/internal/telephony/VirtualNet;->loadVirtualNet(Ljava/lang/String;Lcom/android/internal/telephony/uicc/SIMRecords;)V

    invoke-direct {p0}, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->checkGlobalAutoMatchParam()V
...
.method public onOperatorNumericLoaded()V
    ...
    .prologue
    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->checkPrePostPayMactchParam()V

    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->checkAgpsServers()V
    ...
    invoke-static {v0, v1}, Lcom/android/internal/telephony/VirtualNet;->loadSpecialFiles(Ljava/lang/String;Lcom/android/internal/telephony/uicc/SIMRecords;)V

    invoke-direct {p0}, Lcom/android/internal/telephony/uicc/SIMRecords$GlobalChecker;->checkGlobalEccNum()V
