...
.method public getAdnRecordsInEf(I)Ljava/util/List;
    ...
    .prologue
    iget-object v4, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->mLock2:Ljava/lang/Object;
    ...
    const-string v3, "xxl phone.mIccRecords is not null"
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->adnCache:Lcom/android/internal/telephony/uicc/AdnRecordCache;
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->adnCache:Lcom/android/internal/telephony/uicc/AdnRecordCache;

    invoke-virtual {v6, p1}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->extensionEfForEf(I)I

    move-result v6

    invoke-virtual {v3, p1, v6, v1}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->requestLoadAllAdnLike(IILandroid/os/Message;)V
    ...
    :try_start_3
    const-string v3, "getAdnRecordsInEF: after wait"

    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->logd(Ljava/lang/String;)V

    iget-object v3, p0, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->records:Ljava/util/List;
...
.method public getAlphaTagEncodingLength(Ljava/lang/String;)I
    ...
    .prologue
    invoke-static {p1}, Lcom/android/internal/telephony/uicc/AdnRecord;->getAlphaTagEncodingLength(Ljava/lang/String;)I
