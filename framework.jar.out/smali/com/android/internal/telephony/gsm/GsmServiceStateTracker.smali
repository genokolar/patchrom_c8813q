...
.field private bGlobalModeInLimitedService:Z
...
.method public constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    const-string v3, "ro.config.limit_global_mode"

    invoke-static {v3, v5}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->bGlobalModeInLimitedService:Z
...
.method private pollStateDone()V
    ...
    const-string v40, "android.intent.action.START_SEC_NET_SEL"
    ...
    .local v23, intent_sel2:Landroid/content/Intent;
    const-string v40, "gsm.limited.plmn"
    ...
    .local v25, limited_service_plmn:Ljava/lang/String;
    ...
    const-string v42, "SubscriptionManager:state="
    ...
    const-string v42, " isEmergencyOnly="
    ...
    invoke-virtual/range {v42 .. v42}, Landroid/telephony/ServiceState;->isEmergencyOnly()Z
    ...
    const-string v42, " gsm.limited.plmn="
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->bGlobalModeInLimitedService:Z
    ...
    invoke-virtual/range {v40 .. v40}, Landroid/telephony/ServiceState;->isEmergencyOnly()Z
    ...
    const-string v42, "SubscriptionManager: broadcast intent for re-selection in limited service, plmn_gsm = "
    ...
    const-string v40, "gsm.globalmode.plmn.gsm"
    ...
    .end local v23           #intent_sel2:Landroid/content/Intent;
    .end local v25           #limited_service_plmn:Ljava/lang/String;
    :cond_7
    if-nez v29, :cond_1e
    ...
    const-string v41, "mDataState ss.getRoaming()"
    ...
    const-string v41, "mDataState newSS.getRoaming()"
    ...
    const-string v41, "NoServiceDebug:sub is:"
    ...
    invoke-virtual/range {v41 .. v41}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSubscription()I
    ...
    const-string v42, "ro.hw.display_no_service_delay"
    ...
    const-string v41, ",is from in service to out of service:"
    ...
    const-string v41, ",ss.getstate is:"
    ...
    sget-boolean v40, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->IS_DELAYED_DISPLAY_NO_SERVICE:Z
    ...
    const-string v41, ",is going to send delayed message right away"
    ...
    invoke-virtual/range {v40 .. v40}, Lcom/android/internal/telephony/gsm/GSMPhone;->getIccCard()Lcom/android/internal/telephony/IccCard;
    ...
    invoke-interface/range {v22 .. v22}, Lcom/android/internal/telephony/IccCard;->getIccCardState()Lcom/android/internal/telephony/IccCard$State;

    move-result-object v40

    sget-object v41, Lcom/android/internal/telephony/IccCard$State;->READY:Lcom/android/internal/telephony/IccCard$State;
    ...
    const-string v40, "ro.config_hw_doubletime"
    ...
    const-string v40, "[settimezone]roaming on, waiting for a few minutes to see if the NITZ is supported by the current network."
    ...
    .local v31, roamingOn:Landroid/os/Message;
    const/16 v40, 0x64
    ...
    .end local v31           #roamingOn:Landroid/os/Message;
    :cond_e
    move-object/from16 v0, p0
    ...
    .restart local v23       #intent_sel2:Landroid/content/Intent;
    .restart local v25       #limited_service_plmn:Ljava/lang/String;
    ...
    const-string v42, "SubscriptionManager: broadcast intent for re-selection, plmn_gsm = "
    ...
    const-string v42, "NITZ: pollStateDone to get zone infor, zone = "
    ...
    :cond_30
    const-string v40, "NoServiceDebug: There is delayed message in message queue already!"
    ...
    const-string v41, ",service state turned to In Service..so remove message from message queue"
    ...
    const-string v40, "NoServiceDebug"

    new-instance v41, Ljava/lang/StringBuilder;

    invoke-direct/range {v41 .. v41}, Ljava/lang/StringBuilder;-><init>()V

    const-string v42, "[GsmSST] sub is:"
    ...
    invoke-virtual/range {v42 .. v42}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSubscription()I
    ...
    const-string v42, ",notify listener service state changed!"
    ...
    .end local v29           #operatorNumeric:Ljava/lang/String;
    .end local v30           #prevOperatorNumeric:Ljava/lang/String;
    .restart local v22       #iccCard:Lcom/android/internal/telephony/IccCard;
    :cond_33
    const-string v40, "GSM"
...
.method private setCustPlmnNoRoam()Z
    ...
    const-string v9, "mDataState phone.mIccRecords.get() == null"
    ...
    const-string v10, "mDataState phone.mIccRecords.get().getOperatorNumeric()==="
    ...
    const-string v10, "mDataState TelephonyManager.getDefault().getSimOperator() ==="
    ...
    const-string v10, "mDataState in setCustPlmnNoRoam() roaming = true-- excute??"
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->checkForRoamingForIndianOperators(Landroid/telephony/ServiceState;)Z
    ...
    const-string v19, "mDataState roaming = setCustPlmnNoRoam()======"
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->IS_CHINA_TELECOM:Z
    ...
    invoke-virtual/range {v18 .. v19}, Landroid/telephony/ServiceState;->setRoaming(Z)V
    ...
    const-string v20, "[EONS] Received TAC = "
    ...
    const-string v20, "[EONS] EVENT_POLL_STATE_GPRS newGPRSState ="
    ...
    const-string v20, " , mDataRadioTechnology ="
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isPlmnInDefaultsXml(Ljava/lang/String;)Z
    ...
    .local v3, LongPlmn:Ljava/lang/String;
    if-eqz v3, :cond_5
    ...
    .end local v3           #LongPlmn:Ljava/lang/String;
    :cond_16
    move-object/from16 v0, p0
    ...
    const-string v19, "hw_cntelcustplmn_g"

    invoke-static/range {v18 .. v19}, Landroid/provider/SettingsEx$Systemex;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    .local v5, cntelcustplmn:Ljava/lang/String;
    const/16 v18, 0x2
    ...
    invoke-virtual {v0, v1, v5}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->setCustLongOperator(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_1

    .end local v5           #cntelcustplmn:Ljava/lang/String;
...
.method protected updateSpnDisplay()V
    ...
    const-string v24, "hw_cntelcustplmn_g"
