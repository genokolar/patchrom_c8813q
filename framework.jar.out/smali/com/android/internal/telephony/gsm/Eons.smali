...
.method public getEonsForAvailableNetworks(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    .local v2, eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/gsm/Eons$EonsState;->isPnnAndOplPresent()Z

    move-result v9

    if-nez v9, :cond_0

    const-string v9, "OPL/PNN data is not available. Use the network names from Ril."

    invoke-direct {p0, v9}, Lcom/android/internal/telephony/gsm/Eons;->loge(Ljava/lang/String;)V
    ...
    .end local v2           #eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    invoke-direct {v2, v8}, Ljava/util/ArrayList;-><init>(I)V

    .restart local v2       #eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/OperatorInfo;>;"
    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "Available Networks List Size = "
    ...
    invoke-direct {p0, v9}, Lcom/android/internal/telephony/gsm/Eons;->log(Ljava/lang/String;)V
    ...
    .local v1, TempPlmn:Ljava/lang/String;
    const/4 v0, 0x0

    .local v0, TempOperatorNumeric:Ljava/lang/String;
    ...
    .local v7, radioTechStr:Ljava/lang/String;
    const/4 v9, -0x1
    ...
    iget-object v9, p0, Lcom/android/internal/telephony/gsm/Eons;->mOplRecords:Lcom/android/internal/telephony/gsm/OplRecords;

    const/4 v10, -0x1

    const/4 v11, 0x0

    invoke-virtual {v9, v1, v10, v11}, Lcom/android/internal/telephony/gsm/OplRecords;->getMatchingPnnRecord(Ljava/lang/String;IZ)I

    move-result v6

    iget-object v9, p0, Lcom/android/internal/telephony/gsm/Eons;->mPnnRecords:Lcom/android/internal/telephony/gsm/PnnRecords;

    const/4 v10, 0x0

    invoke-virtual {v9, v6, v10}, Lcom/android/internal/telephony/gsm/PnnRecords;->getNameFromPnnRecord(IZ)Ljava/lang/String;
    ...
    const-string v10, "after add radioTechStr,pnnName = "
    ...
    invoke-direct {v9, v5, v10, v11, v12}, Lcom/android/internal/telephony/OperatorInfo;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/OperatorInfo$State;)V
    ...
    .end local v0           #TempOperatorNumeric:Ljava/lang/String;
    .end local v1           #TempPlmn:Ljava/lang/String;
    .end local v3           #i:I
    .end local v4           #ni:Lcom/android/internal/telephony/OperatorInfo;
    .end local v5           #pnnName:Ljava/lang/String;
    .end local v6           #pnnRecord:I
    .end local v7           #radioTechStr:Ljava/lang/String;
    .end local v8           #size:I
    :cond_5
    const-string v9, "Available Networks List is empty"
