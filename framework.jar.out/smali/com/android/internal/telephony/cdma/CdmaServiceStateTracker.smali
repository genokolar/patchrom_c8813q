...
# instance fields
.field protected IS_CDG_TEST:Z

.field protected IS_CHINA_TELECOM:Z

.field protected bSupportGlobalMode:Z
...
.method public constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->bSupportGlobalMode:Z

    iput-boolean v4, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsForcedToUpdateSpn:Z

    iput-boolean v4, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsDelaying:Z
    ...
    :goto_0
    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->IS_CHINA_TELECOM:Z

    const-string v2, "ro.config.ct_cdg_test"

    invoke-static {v2, v4}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->IS_CDG_TEST:Z
...
.method private getAutoTime()Z
    ...
    const-string v1, "UNSOL_NITZ need to ignore in case of CDMA"
...
.method private setTimeFromNITZString(Ljava/lang/String;J)V
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->IS_CHINA_TELECOM:Z
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->IS_CDG_TEST:Z
    ...
    const-string v34, "[xueyongxin] NITZ: zone = "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :goto_3
    const-string v4, "ro.cfg.apn_user_modify_common"
    ...
    const-string v4, "ro.cfg.apn_pwd_modify_common"
    ...
    const-string v21, "comandroidrestoreapn-true"
    ...
    const-string v4, "android.intent.action.UPDATE_RELATION_APN"
    ...
    :sswitch_a
    const-string v4, "persist.timed.enable"
    ...
    :cond_e
    const-string v4, "EVENT_NITZ_TIME received, ignore updating time"
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/huawei/telephony/HuaweiTelephonyManager;->getDualCardMode()I
    ...
    invoke-virtual {v0, v15}, Lcom/huawei/telephony/HuaweiTelephonyManager;->rilMode2DualMode(I)S
    ...
    const-string v22, "EVENT_GET_PREF_NETWORKS, exception="
    ...
    const-string v22, "fail to EVENT_GET_PREF_NET, exception = "
    ...
    .end local v15           #nMode:I
    :sswitch_12
    const-string v4, "NoServiceDebug,received delayed message"
    ...
    iput-boolean v4, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsDelaying:Z

    const/4 v4, 0x1

    move-object/from16 v0, p0

    iput-boolean v4, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsForcedToUpdateSpn:Z

    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->updateSpnDisplay()V

    const-string v4, "NoServiceDebug"

    const-string v21, "[CdmaSST] delayed message received! notify service state changed"
    ...
    invoke-virtual {v0, v4}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyServiceStateChanged(Landroid/telephony/ServiceState;)V
...
.method protected handlePollStateResultMessage(ILandroid/os/AsyncResult;)V
    ...
    invoke-virtual {v0, v15}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->setCdmaTechnology(I)V
    ...
    iget-boolean v3, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->IS_CHINA_TELECOM:Z
    ...
    invoke-virtual {v0, v3}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isPlmnInDefaultsXml(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_18

    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->getplmn()Ljava/lang/String;

    move-result-object v9

    .local v9, LongPlmn:Ljava/lang/String;
    if-eqz v9, :cond_0
    ...
    invoke-virtual {v3, v9}, Landroid/telephony/ServiceState;->setOperatorAlphaLong(Ljava/lang/String;)V

    goto/16 :goto_0

    .end local v9           #LongPlmn:Ljava/lang/String;
    :cond_18
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->cr:Landroid/content/ContentResolver;

    const-string v21, "hw_cntelcustplmn_c"

    move-object/from16 v0, v21

    invoke-static {v3, v0}, Landroid/provider/SettingsEx$Systemex;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    .local v10, cntelcustplmn:Ljava/lang/String;
    const/4 v3, 0x2
    ...
    invoke-virtual {v0, v3, v10}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->setCustLongOperator(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_0

    .end local v10           #cntelcustplmn:Ljava/lang/String;
    :cond_19
...
.method protected pollStateDone()V
    ...
    .local v11, hasChangedToOutOfService:Z
    :goto_a
    move-object/from16 v0, p0
    ...
    const-string v27, "ro.config_hw_doubletime"
    ...
    const-string v28, "last_registed_mcc"
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->bSupportGlobalMode:Z
    ...
    const-string v27, "android.intent.action.START_SEC_NET_SEL"
    ...
    .local v18, intent_sel2:Landroid/content/Intent;
    ...
    const-string v29, "SubscriptionManager: broadcast intent for re-selection, plmn_cdma = "
    ...
    const-string v27, "gsm.globalmode.plmn.cdma"
    ...
    .end local v18           #intent_sel2:Landroid/content/Intent;
    :cond_7
    if-nez v23, :cond_1d

    const-string v27, "operatorNumeric is null"
    ...
    const-string v28, "NoServiceDebug:isPropOpen:"

    invoke-virtual/range {v27 .. v28}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v27

    sget-boolean v28, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->IS_DELAYED_DISPLAY_NO_SERVICE:Z

    invoke-virtual/range {v27 .. v28}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v27

    const-string v28, ",is from in service to out of service:"
    ...
    sget-boolean v27, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->IS_DELAYED_DISPLAY_NO_SERVICE:Z
    ...
    const-string v28, "NoServiceDebug:!hasMessages:"
    ...
    iput-boolean v0, v1, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsDelaying:Z
    ...
    const-string v27, "NoServiceDebug:[CdmaLteSST] is going to send delayed message right away"
    ...
    const-string v27, "ro.hw.display_no_service_delay"
    ...
    .end local v11           #hasChangedToOutOfService:Z
    ...
    .restart local v11       #hasChangedToOutOfService:Z
    ...
    :cond_20
    const-string v27, "NoServiceDebug: There is delayed message in message queue!"
    ...
    :cond_21
    const-string v27, "NoServiceDebug:service state turned to In Service..so remove message from message queue"
    ...
    const-string v27, "NoServiceDebug"

    const-string v28, "[CdmaSST] notify listener service state changed!"
...
.method protected updateSpnDisplay()V
    ...
    iget-boolean v15, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsForcedToUpdateSpn:Z
    ...
    iget-boolean v14, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsDelaying:Z
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->log(Ljava/lang/String;)V
    ...
    iget-boolean v14, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsForcedToUpdateSpn:Z
    ...
    iput-boolean v14, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsForcedToUpdateSpn:Z
    ...
    iget-object v14, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->cr:Landroid/content/ContentResolver;
    ...
    iput-object v11, v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mCurPlmn:Ljava/lang/String;
