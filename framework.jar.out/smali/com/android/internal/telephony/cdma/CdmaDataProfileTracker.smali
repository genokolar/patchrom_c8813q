...
.field private static final NOT_ROAMING:Ljava/lang/String; = "not roaming"
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->IS_CHINATELECOM:Z
...
.method public getDataProfile(Ljava/lang/String;)Lcom/android/internal/telephony/DataProfile;
    ...
    .local v6, profile:Lcom/android/internal/telephony/DataProfile;
    iget-object v12, p0, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->mPhone:Lcom/android/internal/telephony/cdma/CDMAPhone;
    ...
    const-string v12, "first_roming"

    invoke-static {v1, v12}, Landroid/provider/SettingsEx$Systemex;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .local v3, firRoaming:Ljava/lang/String;
    ...
    :cond_0
    sget-boolean v10, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->IS_CHINATELECOM:Z
    ...
    :cond_1
    iget-object v10, p0, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->mDataProfilesList:Ljava/util/ArrayList;
    ...
    .local v2, dp:Lcom/android/internal/telephony/DataProfile;
    const-string v10, "ctnet"

    iget-object v11, v2, Lcom/android/internal/telephony/DataProfile;->apn:Ljava/lang/String;
    ...
    sget-object v10, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->PREFERAPN_URI:Landroid/net/Uri;

    invoke-virtual {v1, v10, v13, v13}, Landroid/content/ContentResolver;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I

    const-string v10, "apn_id"

    iget v11, v2, Lcom/android/internal/telephony/DataProfile;->id:I
    ...
    invoke-virtual {v1, v10, v9}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;

    const-string v10, "first_roming"

    const-string v11, "roaming"

    invoke-static {v1, v10, v11}, Landroid/provider/SettingsEx$Systemex;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z

    move-object v7, v6

    .end local v2           #dp:Lcom/android/internal/telephony/DataProfile;
    .end local v4           #i$:Ljava/util/Iterator;
    .end local v6           #profile:Lcom/android/internal/telephony/DataProfile;
    .local v7, profile:Lcom/android/internal/telephony/DataProfile;
    :goto_2
    return-object v7

    .end local v7           #profile:Lcom/android/internal/telephony/DataProfile;
    .restart local v6       #profile:Lcom/android/internal/telephony/DataProfile;
    :cond_3
    move v8, v11
    ...
    invoke-virtual {v12}, Landroid/telephony/TelephonyManager;->getNetworkRoamingCT()I
    ...
    .end local v6           #profile:Lcom/android/internal/telephony/DataProfile;
    .restart local v7       #profile:Lcom/android/internal/telephony/DataProfile;
    goto :goto_2
    ...
    const-string v11, "getDataProfile:"

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v11, v6, Lcom/android/internal/telephony/DataProfile;->apn:Ljava/lang/String;

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    const-string v11, ",apn id="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    invoke-virtual {v6}, Lcom/android/internal/telephony/DataProfile;->getProfileId()I
    ...
    invoke-virtual {p0, v10}, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->log(Ljava/lang/String;)V
    ...
    iget-boolean v10, p0, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->mIsOmhEnabled:Z
    ...
    sget-object v11, Lcom/android/internal/telephony/DataProfile$DataProfileType;->PROFILE_TYPE_OMH:Lcom/android/internal/telephony/DataProfile$DataProfileType;
