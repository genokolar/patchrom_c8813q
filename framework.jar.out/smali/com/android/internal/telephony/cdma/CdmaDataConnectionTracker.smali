...
.field private static final IS_CHINATELECOM:Z
...
.field protected mIsGsmInCall:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->IS_CHINATELECOM:Z
...
.method protected constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    iput-boolean v1, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mIsGsmInCall:Z
...
.method private cwIsNotUsed()Z
    ...
    const-string v2, "net.service.pppd.enable"
    ...
    const-string v1, "C+W is connecting, this data call request will be abandon!"
...
.method private onDialupStateChanged(Landroid/os/AsyncResult;)V
    ...
    iput v0, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mDialupState:I

    if-ne v3, v0, :cond_2

    const-string v1, "dialupOn"

    invoke-virtual {p0, v3, v1, v2}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->cleanUpConnection(ZLjava/lang/String;Z)V
...
.method private setupData(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v4}, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->getDataProfile(Ljava/lang/String;)Lcom/android/internal/telephony/DataProfile;
    ...
    :cond_1
    sget-boolean v2, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->IS_CHINATELECOM:Z
    ...
    iget-object v2, v2, Lcom/android/internal/telephony/cdma/DataProfileCdma;->pppNumber:Ljava/lang/String;
    ...
    const-string v4, "pppNumber is error:"
...
.method private triggerDataSetup(Ljava/lang/String;)V
    ...
    .prologue
    const-string v1, "onRecordsLoaded(): calling readDataProfilesFromModem()"
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->isOmhEnabled()Z
    ...
    const-string v2, "onRecordsLoaded(): Profiles are ready - trigger setup_data with reason: "
...
.method private trySetupData(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->getAnyDataEnabledForMMS()Z
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->cwIsNotUsed()Z
...
.method protected getAnyDataEnabledForMMS()Z
    .locals 4
    ...
    sget-boolean v1, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->MMS_ON_ROAMING:Z
    ...
    :cond_0
    sget-boolean v1, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->sPolicyDataEnabled:Z
    ...
    const-string v2, "getAnyDataEnabled for MMS "
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;
...
.method protected onDataStateChanged(Landroid/os/AsyncResult;)V
    ...
    .local v6, isActiveOrDormantConnectionPresent:Z
    const/4 v0, 0x0
    ...
    check-cast v8, Lcom/android/internal/telephony/DataCallState;

    iget v0, v8, Lcom/android/internal/telephony/DataCallState;->active:I
    ...
    iget v8, v2, Lcom/android/internal/telephony/DataCallState;->cid:I
    ...
    iget-object v8, v7, Lcom/android/internal/telephony/DataConnection$UpdateLinkPropertyResult;->setupResult:Lcom/android/internal/telephony/DataCallState$SetupResult;

    sget-object v9, Lcom/android/internal/telephony/DataCallState$SetupResult;->ERR_Stale:Lcom/android/internal/telephony/DataCallState$SetupResult;

    if-ne v8, v9, :cond_2

    const-string v8, "onDataStateChanged(ar): state is Inactive no changes"
    ...
    invoke-virtual {v8}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getPhoneType()I
    ...
    const-string v8, "lihaiwei CdmaDataConnectionTracker onDataStateChanged isCDMA"
    ...
    const-string v9, "lihaiwei CdmaDataConnectionTracker onDataStateChanged desiredPowerState = "
    ...
    invoke-virtual {p0, v11, v12, v10}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->cleanUpConnection(ZLjava/lang/String;Z)V

    goto :goto_0

    .end local v4           #desiredPowerState:Z
    .restart local v3       #dcac:Lcom/android/internal/telephony/DataConnectionAc;
    .restart local v7       #result:Lcom/android/internal/telephony/DataConnection$UpdateLinkPropertyResult;
    :cond_2
    iget-object v8, v7, Lcom/android/internal/telephony/DataConnection$UpdateLinkPropertyResult;->oldLp:Landroid/net/LinkProperties;
    ...
    const-string v8, "onDataStateChanged(ar): no change"
    ...
    :cond_3
    const-string v8, "onDataStateChanged(ar): there is a change"
    ...
    invoke-virtual {v8, v9}, Landroid/net/LinkProperties;->isIdenticalInterfaceName(Landroid/net/LinkProperties;)Z
    ...
    invoke-virtual {v8, v9}, Landroid/net/LinkProperties;->isIdenticalDnses(Landroid/net/LinkProperties;)Z
    ...
    invoke-virtual {v8, v9}, Landroid/net/LinkProperties;->isIdenticalRoutes(Landroid/net/LinkProperties;)Z
    ...
    invoke-virtual {v8, v9}, Landroid/net/LinkProperties;->isIdenticalHttpProxy(Landroid/net/LinkProperties;)Z
    ...
    invoke-virtual {v8, v9}, Landroid/net/LinkProperties;->isIdenticalAddresses(Landroid/net/LinkProperties;)Z
    ...
    invoke-virtual {v8, v9}, Lcom/android/internal/telephony/PhoneBase;->notifyDataConnection(Ljava/lang/String;)V
    ...
    .end local v7           #result:Lcom/android/internal/telephony/DataConnection$UpdateLinkPropertyResult;
    :cond_5
    iget v8, v2, Lcom/android/internal/telephony/DataCallState;->status:I

    invoke-static {v8}, Lcom/android/internal/telephony/DataConnection$FailCause;->fromInt(I)Lcom/android/internal/telephony/DataConnection$FailCause;

    move-result-object v8

    sget-object v9, Lcom/android/internal/telephony/DataConnection$FailCause;->TETHERED_CALL_ACTIVE:Lcom/android/internal/telephony/DataConnection$FailCause;
    ...
    const-string v9, "setTetheredCallOn for apn:"
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/DataProfile;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v8, v11}, Lcom/android/internal/telephony/DataProfile;->setTetheredCallOn(Z)V
    ...
    :cond_7
    const-string v8, "Due to radio turn off cleanup the data call"

    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->log(Ljava/lang/String;)V

    const-string v8, "radioTurnedOff"

    invoke-virtual {p0, v10, v8, v10}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->cleanUpConnection(ZLjava/lang/String;Z)V

    goto/16 :goto_0

    .end local v4           #desiredPowerState:Z
    :cond_8
    const-string v8, "Data reconnect disabled due to radio technology changed"
    ...
    .end local v6           #isActiveOrDormantConnectionPresent:Z
    :cond_a
    new-instance v8, Ljava/lang/StringBuilder;
...
.method protected onEnableApn(II)V
    ...
    const-string v2, "The APN to be disabled is the same as defalut type APN"
    ...
    invoke-virtual {p0, v2, v5}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->notifyApnIdUpToCurrent(Ljava/lang/String;I)V
...
.method public storeHttpProxyAfterDataActive()V
    ...
    sget-boolean v5, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->IS_CHINATELECOM:Z
    ...
    :cond_1
    const-string v5, "not china telecom cdma roaming, set ctwap proxy"
