...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->IS_CHINATELECOM:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v3, "[=XYX=] mPrlVersion is empty , set mPrlVersion to "
    ...
    :sswitch_2
    const-string v2, "NoServiceDebug,received delayed message"

    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->log(Ljava/lang/String;)V

    const/4 v2, 0x0

    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsDelaying:Z
    ...
    const-string v2, "NoServiceDebug"

    const-string v3, "[CdmaLteSST] delayed message received! notify service state changed"
...
.method protected handlePollStateResultMessage(ILandroid/os/AsyncResult;)V
    ...
    iget-boolean v4, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mDataRoaming:Z
...
.method protected pollStateDone()V
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/telephony/ServiceState;->getRilRadioTechnology()I
    ...
    invoke-virtual/range {v32 .. v33}, Landroid/telephony/ServiceState;->setRadioTechnology(I)V

    new-instance v32, Ljava/lang/StringBuilder;

    invoke-direct/range {v32 .. v32}, Ljava/lang/StringBuilder;-><init>()V

    const-string v33, "pollStateDone CdmaLTEServiceState STATE_IN_SERVICE newNetworkType = "
    ...
    const-string v32, "pollState: LTE Only mode"
    ...
    const-string v33, "pollStateDone: oldSS=["
    ...
    .local v12, hasChangedToOutOfService:Z
    :goto_d
    new-instance v32, Ljava/lang/StringBuilder;
    ...
    const-string v33, " hasRadioTechnologyChanged = "
    ...
    const-string v32, "GsmDataConnectionTracker Created"
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/telephony/DataConnectionTracker;->dispose()V
    ...
    const-string v32, "GsmDataConnectionTracker disposed"
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/telephony/cdma/CDMAPhone;->isEriFileLoaded()Z
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getState()Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;

    move-result-object v32

    sget-object v33, Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;->APPSTATE_READY:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/telephony/uicc/RuimRecords;->getCsimSpnDisplayCondition()Z
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/telephony/ServiceState;->getCdmaEriIconIndex()I
    ...
    sget-boolean v32, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->IS_CHINATELECOM:Z

    if-eqz v32, :cond_2b

    const-string v32, "china telecom, no need to use operator name from CSIM record"
    ...
    const-string v32, "android.intent.action.START_SEC_NET_SEL"
    ...
    const-string v34, "SubscriptionManager: broadcast intent for re-selection, plmn_lte = "
    ...
    const-string v32, "gsm.globalmode.plmn.cdma"
    ...
    const-string v33, "NoServiceDebug:isPropOpen:"

    invoke-virtual/range {v32 .. v33}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v32

    sget-boolean v33, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->IS_DELAYED_DISPLAY_NO_SERVICE:Z

    invoke-virtual/range {v32 .. v33}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v32

    const-string v33, ",is from in service to out of service:"
    ...
    sget-boolean v32, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->IS_DELAYED_DISPLAY_NO_SERVICE:Z
    ...
    const-string v33, "NoServiceDebug:!hasMessages:"
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->obtainMessage()Landroid/os/Message;
    ...
    const-string v32, "NoServiceDebug:[CdmaLteSST] is going to send delayed message right away"
    ...
    const-string v32, "ro.hw.display_no_service_delay"
    ...
    .end local v12           #hasChangedToOutOfService:Z
    ...
    .restart local v12       #hasChangedToOutOfService:Z
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/telephony/uicc/IccRecords;->getServiceProviderName()Ljava/lang/String;
    ...
    const-string v32, "ro.cdma.home.operator.alpha"
    ...
    .end local v5           #eriText:Ljava/lang/String;
    .restart local v21       #iconIndex:I
    .restart local v29       #showSpn:Z
    :cond_2b
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v33 .. v33}, Lcom/android/internal/telephony/uicc/IccRecords;->getServiceProviderName()Ljava/lang/String;
    ...
    :cond_2f
    const-string v32, "NoServiceDebug: There is delayed message in message queue already!"
    ...
    :cond_30
    const-string v32, "NoServiceDebug:service state turned to In Service..so remove message from message queue"
    ...
    const-string v32, "NoServiceDebug"

    const-string v33, "[CdmaLteSST] notify listener service state changed!"
