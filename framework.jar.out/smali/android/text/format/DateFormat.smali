...
.method public static final format(Ljava/lang/CharSequence;Ljava/util/Calendar;)Ljava/lang/CharSequence;
    ...
    iget-char v6, v8, Llibcore/icu/LocaleData;->zeroDigit:C
    ...
    invoke-virtual {v5, v2, v8, v4}, Landroid/text/SpannableStringBuilder;->replace(IILjava/lang/CharSequence;)Landroid/text/SpannableStringBuilder;
    ...
    invoke-static {v8, v1, v6}, Landroid/text/format/DateFormat;->zeroPad(IIC)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {v7, v1, v6}, Landroid/text/format/DateFormat;->zeroPad(IIC)Ljava/lang/String;
    ...
    .end local v4           #replacement:Ljava/lang/String;
    :sswitch_7
    invoke-static {p1, v1, v6}, Landroid/text/format/DateFormat;->getMonthString(Ljava/util/Calendar;IC)Ljava/lang/String;
    ...
    .end local v4           #replacement:Ljava/lang/String;
    :sswitch_9
    invoke-static {p1, v1, v6}, Landroid/text/format/DateFormat;->getTimeZoneString(Ljava/util/Calendar;IC)Ljava/lang/String;
    ...
    .end local v4           #replacement:Ljava/lang/String;
    :sswitch_a
    invoke-static {p1, v1, v6}, Landroid/text/format/DateFormat;->getYearString(Ljava/util/Calendar;IC)Ljava/lang/String;
...
.method private static final formatZoneOffset(IIC)Ljava/lang/String;
    .locals 6
    .parameter "offset"
    .parameter "count"
    ...
    .local v1, minutes:I
    invoke-static {v0, v5, p2}, Landroid/text/format/DateFormat;->zeroPad(IIC)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-static {v1, v5, p2}, Landroid/text/format/DateFormat;->zeroPad(IIC)Ljava/lang/String;
...
.method private static final getMonthString(Ljava/util/Calendar;IC)Ljava/lang/String;
    .locals 2
    .parameter "inDate"
    .parameter "count"
    .parameter "localeZero"
    ...
    invoke-static {v1, p1, p2}, Landroid/text/format/DateFormat;->zeroPad(IIC)Ljava/lang/String;
...
.method private static final getTimeZoneString(Ljava/util/Calendar;IC)Ljava/lang/String;
    .locals 5
    .parameter "inDate"
    .parameter "count"
    .parameter "localeZero"
    ...
    invoke-static {v2, p1, p2}, Landroid/text/format/DateFormat;->formatZoneOffset(IIC)Ljava/lang/String;
...
.method private static final getYearString(Ljava/util/Calendar;IC)Ljava/lang/String;
    .locals 3
    .parameter "inDate"
    .parameter "count"
    .parameter "localeZero"
    ...
    iget-char p2, v1, Llibcore/icu/LocaleData;->zeroDigit:C

    if-gt p1, v2, :cond_0

    rem-int/lit8 v1, v0, 0x64

    invoke-static {v1, v2, p2}, Landroid/text/format/DateFormat;->zeroPad(IIC)Ljava/lang/String;
    ...
    invoke-static {v1, p2}, Landroid/text/format/Time;->localizeDigits(Ljava/lang/String;C)Ljava/lang/String;
...
.method private static zeroPad(IIC)Ljava/lang/String;
    .locals 6
    .parameter "inValue"
    ...
    invoke-static {v0, p2}, Landroid/text/format/Time;->localizeDigits(Ljava/lang/String;C)Ljava/lang/String;
