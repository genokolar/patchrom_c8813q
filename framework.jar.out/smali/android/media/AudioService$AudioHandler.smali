...
.method private persistVolume(Landroid/media/AudioService$VolumeStreamState;II)V
    ...
    invoke-static {p1}, Landroid/media/AudioService$VolumeStreamState;->access$4600(Landroid/media/AudioService$VolumeStreamState;)I
...
.method private playSoundEffect(II)V
    ...
    invoke-static {}, Landroid/media/AudioService;->access$5200()[Ljava/lang/String;
...
.method private setDeviceVolume(Landroid/media/AudioService$VolumeStreamState;I)V
    ...
    invoke-static {v1, v8}, Landroid/media/AudioService;->access$4200(Landroid/media/AudioService;I)I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v15}, Landroid/media/AudioService$VolumeStreamState;->access$5700(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$7202(Landroid/media/AudioService;I)I
    ...
    invoke-static {v1, v2, v3}, Landroid/media/AudioService;->access$7502(Landroid/media/AudioService;J)J
    ...
    invoke-static {v1, v2, v3, v4}, Landroid/media/AudioService;->access$7600(Landroid/media/AudioService;IJ)V
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$8100(Landroid/media/AudioService;)Landroid/app/AlertDialog;

    move-result-object v2

    #setter for: Landroid/media/AudioService;->mAlertDialog:Landroid/app/AlertDialog;
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$8002(Landroid/media/AudioService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$8000(Landroid/media/AudioService;)Landroid/app/AlertDialog;
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$8200(Landroid/media/AudioService;)Landroid/app/NotificationManager;
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$8300(Landroid/media/AudioService;)Landroid/content/Context;
