...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v3, v0, v1, v12}, Landroid/media/AudioService;->access$8600(Landroid/media/AudioService;ZILjava/lang/String;)Z
    ...
    invoke-static {v3, v5, v6, v7}, Landroid/media/AudioService;->access$7600(Landroid/media/AudioService;IJ)V
    ...
    #calls: Landroid/media/AudioService;->handleDeviceConnection(ZILjava/lang/String;)Z
    invoke-static {v4, v3, v0, v1}, Landroid/media/AudioService;->access$8600(Landroid/media/AudioService;ZILjava/lang/String;)Z
    ...
    const-string v6, " isancConnected = "
    ...
    invoke-static {v3}, Landroid/media/AudioManager;->notifyHeadsetPlug(Z)V

    .end local v24           #isConnected:Z
    .end local v25           #isancConnected:Z
    :cond_e
    :goto_9
    monitor-exit v4
    ...
    .restart local v15       #anc:I
    .restart local v24       #isConnected:Z
    .restart local v25       #isancConnected:Z
    .restart local v26       #microphone:I
    .restart local v31       #state:I
    :cond_f
    const/4 v3, 0x1
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$7400(Landroid/media/AudioService;)V
    ...
    invoke-static {v3, v0}, Landroid/media/AudioService;->access$9100(Landroid/media/AudioService;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$9300(Landroid/media/AudioService;)Ljava/lang/String;
    ...
    #calls: Landroid/media/AudioService;->sendMsgForSecurity(IJ)V
    invoke-static {v3, v4, v5, v6}, Landroid/media/AudioService;->access$7600(Landroid/media/AudioService;IJ)V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$9400(Landroid/media/AudioService;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Landroid/media/AudioService;->access$4002(Landroid/media/AudioService;Z)Z
