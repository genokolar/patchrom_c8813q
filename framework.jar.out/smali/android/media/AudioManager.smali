...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, p0, Landroid/media/AudioManager;->currentDeviceType:I
    ...
    invoke-direct {v0, p0, v1}, Landroid/media/AudioManager$1;-><init>(Landroid/media/AudioManager;Landroid/os/Looper;)V

    iput-object v0, p0, Landroid/media/AudioManager;->mHandler:Landroid/os/Handler;

    invoke-virtual {p0, v2}, Landroid/media/AudioManager;->getDevicesForStream(I)I

    move-result v0

    iput v0, p0, Landroid/media/AudioManager;->currentDeviceType:I
    ...
    iget v2, p0, Landroid/media/AudioManager;->currentDeviceType:I
...
.method static synthetic access$100(Landroid/media/AudioManager;)I
    .locals 1
    .parameter "x0"

    .prologue
    iget v0, p0, Landroid/media/AudioManager;->currentDeviceType:I
...
.method static synthetic access$300(Landroid/media/AudioManager;Ljava/lang/String;)Landroid/media/AudioManager$OnAudioFocusChangeListener;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$400(Landroid/media/AudioManager;)Landroid/media/AudioManager$FocusEventHandlerDelegate;
    .locals 1
    .parameter "x0"
...
.method public static notifyHeadsetPlug(Z)V
    .locals 9
    .parameter "state"
    ...
    const-string v8, "notifyHeadsetPlug, state = "
    ...
    .local v3, mode:I
    :try_start_0
    invoke-interface {v4}, Landroid/media/IAudioService;->getMode()I
    :try_end_0
    ...
    const-string v8, "MODE_IN_CALL, state = "
    ...
    :try_start_1
    invoke-static {v6}, Lcom/huawei/atcommand/HuaweiATUtils$ATCmdType;->fromInt(I)Lcom/huawei/atcommand/HuaweiATUtils$ATCmdType;
    ...
    invoke-static {v5, v6, v7}, Lcom/huawei/atcommand/HuaweiATCmds;->huaweiATResponse(ILcom/huawei/atcommand/HuaweiATUtils$ATCmdType;Ljava/lang/String;)Ljava/lang/Object;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1

    .end local v0           #atType:I
    ...
    const-string v7, "Dead object in getMode"
    ...
    const-string v6, "huaweiATResponse"
    ...
    const-string v8, "not MODE_IN_CALL, state = "
...
.method public adjustStreamVolume(III)V
    ...
    invoke-interface {v2, p2, p3}, Landroid/media/IAudioService;->adjustMasterVolume(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "send adjustStream message"

    invoke-static {v3, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v3, p0, Landroid/media/AudioManager;->mHandler:Landroid/os/Handler;
    ...
    :cond_0
    :try_start_1
    invoke-interface {v2, p1, p2, p3}, Landroid/media/IAudioService;->adjustStreamVolume(III)V
    :try_end_1
    ...
    const-string v4, "Dead object in adjustStreamVolume"
...
.method public adjustSuggestedStreamVolume(III)V
    ...
    invoke-interface {v2, p1, p3}, Landroid/media/IAudioService;->adjustMasterVolume(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "send adjustSuggestedStream message"
    ...
    :cond_0
    :try_start_1
    invoke-interface {v2, p1, p2, p3}, Landroid/media/IAudioService;->adjustSuggestedStreamVolume(III)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public isMicrophoneMute(I)I
    .locals 9
    .parameter "modemType"
    ...
    const-string v7, "isMicrophoneMute: modemType = "
    ...
    .local v1, atResponse:Ljava/lang/Object;
    const/4 v5, 0x1
    ...
    .end local v1           #atResponse:Ljava/lang/Object;
    :goto_0
    sget-object v5, Landroid/media/AudioManager;->TAG:Ljava/lang/String;
    ...
    .restart local v1       #atResponse:Ljava/lang/Object;
    :cond_0
    const/4 v4, 0x0
    ...
    const-string v7, "huaweiATResponse nResult ="
    ...
    const-string v7, "Exception nResult ="
    ...
    const-string v6, "Modem type is not exist"
...
.method public setBluetoothScoOn(Z)V
    ...
    const-string v3, "send SET_BT_SCO_ON message"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v2, p0, Landroid/media/AudioManager;->mHandler:Landroid/os/Handler;
    ...
    const-string v3, "BluetoothSco is already On"
    ...
    const-string v3, "send SET_DEFAULT_ON message"
    ...
    const-string v3, "BluetoothSco is already Off"
...
.method public setMicrophoneMute(IZ)V
    .locals 5
    .parameter "modemType"
    .parameter "on"
    ...
    const-string v3, "setStreamMute: modemType = "
    ...
    :try_start_0
    invoke-static {v2}, Lcom/huawei/atcommand/HuaweiATUtils$ATCmdType;->fromInt(I)Lcom/huawei/atcommand/HuaweiATUtils$ATCmdType;
    ...
    invoke-static {v1, v2, v3}, Lcom/huawei/atcommand/HuaweiATCmds;->huaweiATResponse(ILcom/huawei/atcommand/HuaweiATUtils$ATCmdType;Ljava/lang/String;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "huaweiATResponse"
    ...
    const-string v2, "Modem type is not exist"
...
.method public setSpeakerphoneOn(Z)V
    ...
    const-string v5, "setSpeakerphoneOn: on = "
    ...
    iput v3, p0, Landroid/media/AudioManager;->currentDeviceType:I
    ...
    const-string v5, "currentDeviceType = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Landroid/media/AudioManager;->currentDeviceType:I
    ...
    const-string v4, "send Speaker on message"
    ...
    const-string v4, "Speakerphone is already On"
    ...
    const-string v4, "send SET_DEFAULT_ON message"
    ...
    const-string v4, "Speakerphone is already Off"
...
.method public setStreamVolume(III)V
    ...
    const-string v5, "setStreamVolume: StreamType = "
    ...
    invoke-interface {v2, p2, p3}, Landroid/media/IAudioService;->setMasterVolume(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "send set message"
    ...
    :cond_0
    :try_start_1
    invoke-interface {v2, p1, p2, p3}, Landroid/media/IAudioService;->setStreamVolume(III)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    const-string v4, "Dead object in setStreamVolume"
