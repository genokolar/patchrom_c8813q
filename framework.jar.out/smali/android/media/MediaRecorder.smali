...
# static fields
.field private static final AT_START:Ljava/lang/String; = "AT^REC=1"

.field private static final AT_STOP:Ljava/lang/String; = "AT^REC=0"

.field private static final MEDIARECORDER_TYPE_MTK:I = 0xa
...
.field private mMediaRecorderType:I
...
.method public constructor <init>()V
    ...
    iput v1, p0, Landroid/media/MediaRecorder;->mMediaRecorderType:I
...
.method public native native_start_mtk(Ljava/lang/String;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;
        }
...
.method public native native_stop_mtk()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;
        }
...
.method public prepare()V
    ...
    iget v0, p0, Landroid/media/MediaRecorder;->mMediaRecorderType:I
    ...
    const-string v1, "prepare: MTK modem record do nothing"
...
.method public setOutputFile(Ljava/lang/String;)V
    ...
    const-string v1, "Invalid MTK record file path"
...
.method public start()V
    ...
    iget v1, p0, Landroid/media/MediaRecorder;->mMediaRecorderType:I
    ...
    const-string v2, "AT^REC=1"

    invoke-virtual {v1, v2}, Lcom/huawei/telephony/HuaweiTelephonyManager;->ATDirectChannel(Ljava/lang/String;)[Ljava/lang/String;
    ...
    const-string v2, "MTK modem recrod need set recoed amr file path."
    ...
    invoke-virtual {p0, v1}, Landroid/media/MediaRecorder;->native_start_mtk(Ljava/lang/String;)V
    ...
    const-string v2, "AT command start MTK modem recrod faild"
...
.method public stop()V
    ...
    invoke-virtual {p0}, Landroid/media/MediaRecorder;->native_stop_mtk()V
