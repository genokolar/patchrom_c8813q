...
.method private copyAutoPairingData()V
    ...
    const-string v11, "rename tmp file return false"
    ...
    const-string v10, "/data/misc/bluetooth/"

    const-string v11, "dynamic_auto_pairing.tmp"
    ...
    .end local v3           #fileTmp:Ljava/io/File;
    .local v4, fileTmp:Ljava/io/File;
    :try_start_3
    ...
    const-string v11, "fileTmp.delete() return false"
    ...
    invoke-virtual {v9, v0, v10, v7}, Ljava/io/FileOutputStream;->write([BII)V
    :try_end_5
    ...
    .end local v4           #fileTmp:Ljava/io/File;
    .restart local v3       #fileTmp:Ljava/io/File;
    move-object v8, v9
    ...
    .restart local v2       #file:Ljava/io/File;
    .restart local v4       #fileTmp:Ljava/io/File;
    ...
    const-string v12, "/data/misc/bluetooth/dynamic_auto_pairing.conf"
    ...
    const-string v11, "BluetoothBondState"

    const-string v12, "rename tmp file return false"
