...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/internal/telephony/msim/MSimPhoneFactory;->sMadeMultiSimDefaults:Z

    sput-object v0, Lcom/android/internal/telephony/msim/MSimPhoneFactory;->MsimphoneService:Lcom/android/internal/telephony/PhoneFactory$PhoneServiceInterface;
    ...
    sput-boolean v0, Lcom/android/internal/telephony/msim/MSimPhoneFactory;->isHwDSDAEnabled:Z
    ...
    sput-object v0, Lcom/android/internal/telephony/msim/MSimPhoneFactory;->hwDSDSMode:Ljava/lang/String;
...
.method private static checkValidNetworkMode([II)V
    .locals 5
    .parameter "networkModes"
    .parameter "subId"
    ...
    sget-object v1, Lcom/android/internal/telephony/msim/MSimPhoneFactory;->hwDSDSMode:Ljava/lang/String;
    ...
    const-string v1, "checkValidNetworkMode : networkModes is invalid"
    ...
    sget-boolean v0, Lcom/android/internal/telephony/msim/MSimPhoneFactory;->isHwDSDAEnabled:Z

    if-eqz v0, :cond_1

    const-string v0, "PHONE"

    const-string v1, "checkValidNetworkMode : set networkModes to G+C"
    ...
    const-string v1, "checkValidNetworkMode : set networkModes to G+G"
    ...
    const-string v1, "checkValidNetworkMode : set networkModes to C+G"
...
.method public static makeMultiSimDefaultPhone(Landroid/content/Context;)V
    ...
    invoke-static {v10, v9}, Lcom/android/internal/telephony/msim/MSimPhoneFactory;->checkValidNetworkMode([II)V
    ...
    const-string v19, "after checkValidNetworkMode, Network Mode set to "
    ...
    invoke-direct/range {v18 .. v19}, Lcom/android/internal/telephony/msim/MSimPhoneProxy;-><init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    const-string v19, "Creating MSimCDMALTEPhone sub = "
    ...
    new-instance v19, Lcom/android/internal/telephony/msim/MSimCDMALTEPhone;
    ...
    invoke-direct {v0, v1, v2, v3, v9}, Lcom/android/internal/telephony/msim/MSimCDMALTEPhone;-><init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;I)V
    ...
    :try_start_7
    const-string v16, "com.huawei.telephony.msim.HuaweiPhoneService"
...
.method public static setDefaultSubscription(I)V
    ...
    .prologue
    const-string v1, "persist.radio.default_sub"
