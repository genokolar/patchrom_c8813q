...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v0, "SubscriptionManager-HWNetSelect"
...
.method public matchSubscriptions(Lcom/android/internal/telephony/msim/SubscriptionData;[Lcom/android/internal/telephony/msim/SubscriptionData;[Ljava/lang/String;I)Z
    ...
    const-string v5, "matchSubscriptions"
    ...
    const-string v5, "need change Mode, send Intent to DualCardMgr!"
    ...
    .local v2, setSubscriptionIntent:Landroid/content/Intent;
    sget-boolean v3, Lcom/android/internal/telephony/msim/HWNetSelect;->IS_CHINA_TELECOM_OPTA_OPTB:Z

    if-eqz v3, :cond_3

    const-string v3, "com.huawei.android.dsdscardmanager"

    const-string v5, "com.huawei.android.dsdscardmanager.HWCardManagerTabActivity"
    ...
    const-string v3, "dualmgrstartcause"

    const-string v5, "framework"

    invoke-virtual {v2, v3, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    iget-object v3, p0, Lcom/android/internal/telephony/msim/HWNetSelect;->mContext:Landroid/content/Context;

    invoke-virtual {v3, v2}, Landroid/content/Context;->startActivity(Landroid/content/Intent;)V

    new-instance v0, Landroid/content/Intent;

    const-string v3, "android.intent.action.ACTION_NATIONAL_MODE_CHANGE"
    ...
    .end local v2           #setSubscriptionIntent:Landroid/content/Intent;
    :goto_2
    move v3, v4
    ...
    .restart local v2       #setSubscriptionIntent:Landroid/content/Intent;
    :cond_3
    const-string v3, "com.huawei.android.dsdscardmanager"

    const-string v5, "com.huawei.android.dsdscardmanager.HWCardManagerActivity"
    ...
    const-string v6, "] available true in SubscriptionManager."
    ...
    invoke-virtual {v3, p4, v4}, Lcom/android/internal/telephony/msim/SubscriptionManager;->setCardInfoAvailable(IZ)V
...
.method public setDefaultSubscriptions()V
    ...
    const-string v4, "Dual Mode Card, GSM sub found, activate it!"
    ...
    const-string v4, "Dual Mode Card, GSM sub not found, continue looking!"
