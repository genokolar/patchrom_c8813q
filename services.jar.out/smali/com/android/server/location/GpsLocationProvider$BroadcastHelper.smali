...
.method static synthetic access$4800(Lcom/android/server/location/GpsLocationProvider$BroadcastHelper;Landroid/content/Intent;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private checkAGpsServer(Landroid/content/Intent;)V
    ...
    invoke-static {v3, v1}, Lcom/android/server/location/GpsLocationProvider;->access$4902(Lcom/android/server/location/GpsLocationProvider;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Lcom/android/server/location/GpsLocationProvider;->access$5002(Lcom/android/server/location/GpsLocationProvider;I)I
    :try_end_0
    ...
    #getter for: Lcom/android/server/location/GpsLocationProvider;->mGpsEnabled:Z
    invoke-static {v3}, Lcom/android/server/location/GpsLocationProvider;->access$5100(Lcom/android/server/location/GpsLocationProvider;)Z
    ...
    invoke-static {v3}, Lcom/android/server/location/GpsLocationProvider;->access$4300(Lcom/android/server/location/GpsLocationProvider;)Z
    ...
    invoke-static {v4}, Lcom/android/server/location/GpsLocationProvider;->access$4900(Lcom/android/server/location/GpsLocationProvider;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/server/location/GpsLocationProvider;->access$5000(Lcom/android/server/location/GpsLocationProvider;)I

    move-result v5

    #calls: Lcom/android/server/location/GpsLocationProvider;->native_set_agps_server(ILjava/lang/String;I)V
    invoke-static {v3, v6, v4, v5}, Lcom/android/server/location/GpsLocationProvider;->access$5200(Lcom/android/server/location/GpsLocationProvider;ILjava/lang/String;I)V
...
.method public init()V
    ...
    invoke-static {v1}, Lcom/android/server/location/GpsLocationProvider;->access$4000(Lcom/android/server/location/GpsLocationProvider;)Landroid/content/Context;
