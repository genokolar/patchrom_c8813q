...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v2, p0, Lcom/android/server/MountService;->mPrimaryVolumeExistBeforeSwitch:Z

    iput-boolean v1, p0, Lcom/android/server/MountService;->mSwitching:Z

    iput-boolean v1, p0, Lcom/android/server/MountService;->mSwitchBack:Z

    iput-boolean v1, p0, Lcom/android/server/MountService;->mVolumeRemoving:Z

    iput-boolean v2, p0, Lcom/android/server/MountService;->mPrimaryVolumeMounted:Z

    iput-boolean v1, p0, Lcom/android/server/MountService;->mVolumeInserted:Z
...
.method private doMountVolume(Ljava/lang/String;)I
    ...
    const-string v8, "doMountVolume: uid is "
...
.method private doShareUnshareVolume(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v5, "doShareUnshareVolume: do "
    ...
    const-string v5, "doShareUnshareVolume: path-->"
    ...
    const-string v5, " mUmsAvailable is -->"
    ...
    const-string v5, "now it unmounted and usb out,it will not ums mode and will mount sd card ,path is "
    ...
    const-string v4, "Failed to remount {%s} on path state is unmounted and usb out (%d)"
    ...
    const-string v5, "now it shared and usb out,it will not ums mode and will unshare and mount sd card ,path is "
    ...
    const-string v4, "Failed to remount {%s} on path state is shared and usb out (%d)"
...
.method private doUnmountVolume(Ljava/lang/String;ZZ)I
    ...
    const-string v8, "doUnmountVolume: UnMouting "
    ...
    const-string v8, "doUnMountVolume: uid is "
    ...
    iget-boolean v6, p0, Lcom/android/server/MountService;->mSwitching:Z

    if-eqz v6, :cond_0

    const-string v6, "switch_exception"

    invoke-direct {p0, v6}, Lcom/android/server/MountService;->sendSwitchBroadcast(Ljava/lang/String;)V
...
.method private notifyShareAvailabilityChange(Z)V
    ...
    const-string v9, "notifyShareAvailabilityChange:enter notifyShareAvailabilityChange and mUmsAvailable is "
    ...
    .local v5, unSharePath:Ljava/lang/String;
    :goto_3
    if-nez p1, :cond_2
    ...
    .end local v5           #unSharePath:Ljava/lang/String;
    :cond_3
    iput-boolean p1, p0, Lcom/android/server/MountService;->mSendUmsConnectedOnBoot:Z
    ...
    .restart local v5       #unSharePath:Ljava/lang/String;
    goto :goto_3
.end method
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    iput-boolean v0, v1, Lcom/android/server/MountService;->mVolumeInserted:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/MountService;->mBadRemoving:Z
...
.method public setUsbMassStorageEnabled(Z)V
    ...
    invoke-direct {v6, p0, v3, v2, v11}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v9, "if hw_sd_swith is true,can`t enter here"
    ...
    const-string v10, "enter setUsbMassStorageEnabled,enable is "
    ...
    const-string v10, "setUsbMassStorageEnabled: uid is "
    ...
    const-string v9, "setUsbMassStorageEnabled: enter /storage/sdcard0current state is mounted"
    ...
    invoke-direct {v6, p0, v8, v2, v11}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V

    .restart local v6       #umscb:Lcom/android/server/MountService$UmsEnableCallBack;
    iget-object v8, p0, Lcom/android/server/MountService;->mHandler:Landroid/os/Handler;
    ...
    const-string v9, "setUsbMassStorageEnabled: enter /storage/sdcard1current state is mounted"
    ...
    const-string v10, "will doUnshareVolume path /storage/sdcard0, method-- "
    ...
    invoke-direct {p0, v8, v2, p1}, Lcom/android/server/MountService;->doShareUnshareVolume(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v10, "Failed to remount /storage/sdcard0 after disabling share method "
    ...
    const-string v10, "will dounshareVolume path /storage/sdcard1, method-- "
    ...
    const-string v10, "Failed to remount /storage/sdcard1 after disabling share method "
