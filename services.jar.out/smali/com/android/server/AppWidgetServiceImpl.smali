...
.method getVisibleWidgets(Ljava/util/HashSet;)Z
    ...
    .local v1, aid:Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;
    const/4 v5, 0x0

    .local v5, provider:Lcom/android/server/AppWidgetServiceImpl$Provider;
    const/4 v4, 0x0
    ...
    .end local v1           #aid:Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;
    check-cast v1, Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;

    .restart local v1       #aid:Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;
    if-nez v1, :cond_2
    ...
    :cond_2
    iget-object v5, v1, Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;->provider:Lcom/android/server/AppWidgetServiceImpl$Provider;

    if-eqz v5, :cond_1

    iget-object v4, v5, Lcom/android/server/AppWidgetServiceImpl$Provider;->info:Landroid/appwidget/AppWidgetProviderInfo;

    if-eqz v4, :cond_1

    iget-object v2, v4, Landroid/appwidget/AppWidgetProviderInfo;->provider:Landroid/content/ComponentName;
...
.method onBroadcastReceived(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v8, v10}, Lcom/android/server/AppWidgetServiceImpl;->updateProvidersForPackageLocked(Ljava/lang/String;Ljava/util/Set;)V
...
.method onConfigurationChanged()V
    ...
    invoke-virtual {p0, v7, v5}, Lcom/android/server/AppWidgetServiceImpl;->updateProvidersForPackageLocked(Ljava/lang/String;Ljava/util/Set;)V
...
.method updateProvidersForPackageLocked(Ljava/lang/String;Ljava/util/Set;)V
    .locals 24
    .parameter "pkgName"
    .parameter
    .annotation system Ldalvik/annotation/Signature;
