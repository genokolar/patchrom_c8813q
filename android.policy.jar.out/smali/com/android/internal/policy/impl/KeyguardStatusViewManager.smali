...
.method public constructor <init>(Landroid/view/View;Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;Lcom/android/internal/widget/LockPatternUtils;Lcom/android/internal/policy/impl/KeyguardScreenCallback;Z)V
    ...
    iput-boolean v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->isSupportDoubleTime:Z
    ...
    const-string v5, "ro.config.hw_show_UIM_Card"

    invoke-static {v5, v7}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v5

    iput-boolean v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mShowUIM:Z
    ...
    iput-object v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mSecondDateFormatString:Ljava/lang/String;

    new-instance v5, Ljava/text/SimpleDateFormat;

    iget-object v6, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mSecondDateFormatString:Ljava/lang/String;

    invoke-direct {v5, v6}, Ljava/text/SimpleDateFormat;-><init>(Ljava/lang/String;)V

    iput-object v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mSimpleDateFormat:Ljava/text/SimpleDateFormat;
    ...
    iput-object v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mDateView2:Landroid/widget/TextView;
    ...
    iget-object v6, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mDateView2:Landroid/widget/TextView;
...
.method private createSimText()Lcom/android/internal/policy/impl/KeyguardStatusViewManager$IccText;
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/policy/impl/KeyguardStatusViewManager$IccText;-><init>(Lcom/android/internal/policy/impl/KeyguardStatusViewManager$1;)V
...
.method private getCurrentText()Lcom/android/internal/policy/impl/KeyguardStatusViewManager$IccText;
    ...
    iget-boolean v2, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mShowUIM:Z
...
.method private showDateView2(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mSimpleDateFormat:Ljava/text/SimpleDateFormat;

    invoke-virtual {v1, v0}, Ljava/text/SimpleDateFormat;->setTimeZone(Ljava/util/TimeZone;)V

    iget-object v1, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mDateView2:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mSimpleDateFormat:Ljava/text/SimpleDateFormat;
...
.method private updateCarrierStateWithSimStatus(Lcom/android/internal/telephony/IccCard$State;)V
    ...
    iget v3, v3, Lcom/android/internal/policy/impl/KeyguardStatusViewManager$IccText;->iccPinLockedMessage:I
    ...
    iget v3, v3, Lcom/android/internal/policy/impl/KeyguardStatusViewManager$IccText;->iccPukLockedMessage:I
...
.method refreshDate()V
    ...
    iget-object v7, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mDateFormatString:Ljava/lang/String;
    ...
    :cond_0
    iget-boolean v6, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->isSupportDoubleTime:Z
    ...
    invoke-static {v6}, Landroid/telephony/MSimTelephonyManager;->from(Landroid/content/Context;)Landroid/telephony/MSimTelephonyManager;

    move-result-object v6

    invoke-virtual {v6}, Landroid/telephony/MSimTelephonyManager;->getNetworkRoamingCT()I
    ...
    iget-object v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mDateView2:Landroid/widget/TextView;
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->showDateView2(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v6}, Landroid/telephony/TelephonyManager;->getNetworkRoamingCT()I
    ...
    invoke-direct {p0, v4, v0}, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->showDateView2(Ljava/lang/String;Ljava/lang/String;)V
