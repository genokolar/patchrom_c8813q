...
.method private handleLongPressOnHome()V
    ...
    invoke-virtual {p0, v7, v1, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->performHapticFeedbackLw(Landroid/view/WindowManagerPolicy$WindowState;IZ)Z
    ...
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHomeLongPressed:Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->showOrHideRecentAppsDialog(I)V
    ...
    const-string v5, "senior_mode"

    const/4 v6, 0x0

    invoke-static {v4, v5, v6}, Landroid/provider/SettingsEx$Systemex;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
...
.method private setDefaultHwTheme()V
    ...
    .prologue
    sget-boolean v4, Lcom/android/internal/policy/impl/PhoneWindowManager;->sIsHwTheme:Z
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isFileExists(Ljava/lang/String;)Z
    ...
    invoke-static {v4, v5}, Landroid/util/CommandLineUtil;->rm(Ljava/lang/String;Ljava/lang/String;)Z

    const-string v4, "system"

    const-string v5, "/data/temp_skin_unzip"

    invoke-static {v4, v5}, Landroid/util/CommandLineUtil;->mkdir(Ljava/lang/String;Ljava/lang/String;)Z

    const-string v4, "root"

    const-string v5, "777"

    const-string v6, "/data/temp_skin_unzip"
    ...
    const-string v5, "pwm unZipDefHwt stopped"
    ...
    invoke-static {v2, v4}, Landroid/util/ZipUtil;->unZipFile(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v4}, Landroid/util/CommandLineUtil;->sync(Ljava/lang/String;)Z
    ...
    invoke-static {v4, v5, v6}, Landroid/util/CommandLineUtil;->mv(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z

    const-string v4, "WindowManager"

    const-string v5, "mv HWT_PATH_TEMP_SKIN to HWT_PATH_SKIN"
    ...
    const-string v5, "/data/cust/wallpaper/wallpaper1.jpg"
    ...
    const-string v4, "ro.config.hw_CustomizeWallpaper"
    ...
    const-string v4, "/data/skin/wallpaper/home_wallpaper_0.jpg"

    invoke-direct {p0, v4}, Lcom/android/internal/policy/impl/PhoneWindowManager;->setThemeWallpaper(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v5, "pwm unZipDefHwt except:"
